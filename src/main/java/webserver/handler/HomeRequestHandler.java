...
public class HomeRequestHandler implements UrlMappingHandler {

    private static final String URL_MAPPING_REGEX = "/$|/index.html";
    ...
    public void handle(HttpRequest httpRequest, HttpResponse httpResponse) {
        byte[] bytes;
        try {
            bytes = FileIoUtils.loadFileFromClasspath(TEMPLATES_FILEPATH + "/index.html");
        } catch (IOException e) {
